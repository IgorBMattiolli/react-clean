...
describe("SignUp Component", () => {
  ...
  test("Should show valid password confirmation state if Validation success", () => {
    const { sut } = makeSut();
    Helper.populateField(sut, "passwordConfirmation");
  ...
  test("Should not call AddAccount is form is invalid", async () => {
    const validationError = faker.random.words();
    const { sut, addAccountSpy } = makeSut({
      validationError,
    });
  ...
  test("Should present error if AddAccount fails", async () => {
    ...
    jest.spyOn(addAccountSpy, "add").mockReturnValue(Promise.reject(error));
    await simulateValidSubmit(sut);
